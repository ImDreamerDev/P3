...
java -jar --module-path "%PATH_TO_FX%" --add-modules=javafx.controls --add-modules=javafx.fxml target/P3-1.0-SNAPSHOT-jar-with-dependencies.jar --username=ct --password=1 --projectId=2 --numOfEmps=20 > "tests\%computername%\p2\emp15\%day%-%month%-T-%hour%-%min%.txt"